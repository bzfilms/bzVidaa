export default {
    ...
    install_app_apk_title: 'How to install BzFilms on Android',
    install_app_apk_text: 'We noticed that you use MediaStationX to run BzFilms on Android. We recommend installing BzFilms as an APK app. This will ensure more stable operation and access to all the app\'s features. <br><br>Go to the <span class="account-modal__site">@lampa_group</span> Telegram group to download the latest APK and installation instructions.',
    install_app_apk_qr: 'Scan the QR code to download the BzFilms APK',
